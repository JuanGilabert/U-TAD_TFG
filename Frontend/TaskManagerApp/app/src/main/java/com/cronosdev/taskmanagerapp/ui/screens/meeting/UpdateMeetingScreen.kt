...
fun UpdateMeetingScreen(navController: NavHostController, meetingViewModel: MeetingViewModel) {
    ...
    val uiState by meetingViewModel.editMeetingScreenUiState.collectAsState()
...
fun ShowEditMeetingScreenCards(meetingViewModel: MeetingViewModel, modifier: Modifier) {
    Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = modifier.padding(15.dp, 10.dp)
        ...
        // Mostramos el composable que recogera.
        ShowTimePickerComponentCard("update","Hora de Inicio", onInitHourChange = { meetingViewModel.setHoraInicioReunion(it) }, meetingViewModel.fechaInicioReunion)
        // Mostramos el composable que recogera.
        ...
        // Mostramos el composable que recogera.
        ShowTimePickerComponentCard("update","Hora de Fin", onInitHourChange = { meetingViewModel.setHoraFinReunion(it) }, meetingViewModel.fechaFinReunion)
        // Mostramos el composable que recogera.
