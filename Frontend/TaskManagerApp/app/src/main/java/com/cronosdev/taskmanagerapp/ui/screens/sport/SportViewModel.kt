...
class SportViewModel @Inject constructor(private val sportRepository: SportRepository): ViewModel()  {
    ...
    //
    private val _editSportScreenUiState = MutableStateFlow<UiState?>(null)
    val editSportScreenUiState: StateFlow<UiState?> = _editSportScreenUiState
    //
    ...
    private fun fetchEditSportScreenUIState(state: UiState) { _editSportScreenUiState.value = state }
    ...
    //
    private fun _setSportVariables() {_id = "";
     ...
     * @param sportId ID de la reserva.
     */
    fun fetchSelectedPaintingData(sportId: String) {
