...
class TravelViewModel @Inject constructor(private val travelRepository: TravelRepository): ViewModel()  {
    ...
    //
    private val _editTravelScreenUiState = MutableStateFlow<UiState?>(null)
    val editTravelScreenUiState: StateFlow<UiState?> = _editTravelScreenUiState
    //
    ...
    private fun fetchEditTravelScreenUIState(state: UiState) { _editTravelScreenUiState.value = state }
    ...
    //
    private fun _setTravelVariables() { _id= ""; setNombreDestinoViaje("");
    ...
    //
    fun fetchSelectedPaintingData(travelId: String) {
