...
fun TravelScreen (navController: NavHostController, travelViewModel: TravelViewModel) {
    ...
    LaunchedEffect(Unit) { travelViewModel.fetchAvailableTravels(Destinations.TRAVEL_SCREEN_URL) }
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally, verticalArrangement = Arrangement.Top,
            ...
            if (travelViewModel.showSearchedTravels) travelViewModel.matchTravelsList.data?.let { ShowTravelList(it,
                onCardClick = { id -> travelViewModel.fetchSelectedPaintingData(id); navController.navigate(Destinations.EDIT_TRAVEL_SCREEN_URL) })
            }
...
fun ShowTravelData(listToShow: List<TravelModel>, travel: Int, onCardClick: (String) -> Unit) {
    ...
    OutlinedCard(
        ...
        ShowCustomData("Destino: ${listToShow[travel].nombreDestinoViaje}")
