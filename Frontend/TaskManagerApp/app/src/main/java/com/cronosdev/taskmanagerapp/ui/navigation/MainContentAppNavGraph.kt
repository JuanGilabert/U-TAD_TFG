...
fun MainContentAppNavGraph(
    ...
    NavHost(navController = navController, startDestination = Destinations.ALL_TASKS_SCREEN_URL,
        ...
        composable(Destinations.ART_EDIT_CINEMA_SCREEN_URL) { EditCinemaScreen(navController, cinemaViewModel) }
        // ART MUSIC
        ...
        composable(Destinations.ART_EDIT_MUSIC_SCREEN_URL) { UpdateMusicScreen(navController, musicViewModel) }
        // ART PAINTING
        ...
        composable(Destinations.ART_EDIT_PAINTING_SCREEN_URL) { UpdatePaintingScreen(navController, paintingViewModel) }
        // HEALTH MEDICAMENT
        ...
        composable(Destinations.EDIT_FOOD_SCREEN_URL) { UpdateFoodScreen(navController, foodViewModel) }
        // MEETING
