...
class TaskViewModel @Inject constructor(
    ...
    fun fetchAvailablePaintingTasks(screenCallName: String) {
        viewModelScope.launch(_exceptionHandler + CoroutineCaller(screenCallName, "fetchAvailablePaintingTasks")) {
            ...
            if (_availablePaintingList.code != 200) fetchAllTaskScreenUIState(UiState.Error(_availablePaintingList.message, "fetchAvailablePaintingTasks"))
            else fetchAllTaskScreenUIState(UiState.Success("screenInit", _availablePaintingList.message, "fetchAvailablePaintingTasks"))
        }
    }
