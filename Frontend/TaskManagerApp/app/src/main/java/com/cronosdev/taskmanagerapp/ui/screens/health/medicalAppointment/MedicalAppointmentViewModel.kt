...
class MedicalAppointmentViewModel @Inject constructor(private val medicalAppointmentRepository: MedicalAppointmentRepository): ViewModel()  {
    ...
    //
    private val _editMedicalAppointmentScreenUiState = MutableStateFlow<UiState?>(null)
    val editMedicalAppointmentScreenUiState: StateFlow<UiState?> = _editMedicalAppointmentScreenUiState
    //
    ...
    private fun fetchEditMedicalAppointmentScreenUIState(state: UiState) { _editMedicalAppointmentScreenUiState.value = state }
    ...
    //
    private fun _setMedicalAppointmentVariables() {_id = ""
    ...
    //
    fun fetchSelectedPaintingData(appointmentId: String) {
    ...
    fun fetchAvailableMedicalAppointments(screenCallName: String = "Unknown Screen Caller") {
        viewModelScope.launch(_exceptionHandler + CoroutineCaller(screenCallName, "fetchAvailableMedicalAppointments")) {
            ...
            if (_availableMedicalAppointmentList.code != 200) fetchMedicalAppointmentScreenUIState(
                ...
                _setMedicalAppointmentVariables()
