...
class MedicamentViewModel @Inject constructor(private val medicamentRepository: MedicamentRepository): ViewModel()  {
    ...
    //
    private val _updateMedicamentScreenUiState = MutableStateFlow<UiState?>(null)
    val updateMedicamentScreenUiState: StateFlow<UiState?> = _updateMedicamentScreenUiState
    //
    ...
    private fun fetchEditMedicamentScreenUIState(state: UiState) { _updateMedicamentScreenUiState.value = state }
    ...
    // Set all values
    fun setMedicamentVariables() {_id = "";
    ...
    // Fetch Medicament Data To Update On Screen
    ...
    fun setShowSearchedMedicaments(value: Boolean) { _showSearchedMedicaments = value }
    //
