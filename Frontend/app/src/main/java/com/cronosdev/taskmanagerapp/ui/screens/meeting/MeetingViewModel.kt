...
class MeetingViewModel @Inject constructor(private val meetingRepository: MeetingRepository): ViewModel()  {
    ...
    //
    private val _updateMeetingScreenUiState = MutableStateFlow<UiState?>(null)
    val updateMeetingScreenUiState: StateFlow<UiState?> = _updateMeetingScreenUiState
    //
    ...
    private fun fetchEditMeetingScreenUIState(state: UiState) { _updateMeetingScreenUiState.value = state }
    ...
    // Fetch Meeting Data To Update On Screen
    ...
    fun setShowSearchedMeetings(value: Boolean) { _showSearchedMeetings = value }
    //
