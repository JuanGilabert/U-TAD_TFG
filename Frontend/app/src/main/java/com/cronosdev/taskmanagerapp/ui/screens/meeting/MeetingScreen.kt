...
fun MeetingScreen (navController: NavHostController, meetingViewModel: MeetingViewModel) {
    ...
    LaunchedEffect(Unit) {
        meetingViewModel.setMeetingVariables()
        meetingViewModel.setShowSearchedMeetings(false)
        meetingViewModel.fetchAvailableMeetings(Destinations.MEETING_SCREEN_URL)
    }
