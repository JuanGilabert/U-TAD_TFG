...
fun ShowCreateFoodScreenCards(foodViewModel: FoodViewModel, modifier: Modifier) {
    Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = modifier.padding(15.dp, 10.dp).verticalScroll(rememberScrollState())) {
        ...
        ShowOutlinedTextFieldUpdateDataCard(
            ...
            foodViewModel.nombreRestaurante,
            onTextFieldValueChange = { foodViewModel.setNombreRestaurante(it) }
        )
        // Mostramos el composable que recogera
        ...
        // Mostramos el composable que recogera
        ShowOutlinedTextFieldUpdateDataCard("create","Asistentes", "Indique el numero de asistentes ... ", "", onTextFieldValueChange = { foodViewModel.setAsistentesReserva(it.toInt()) })
