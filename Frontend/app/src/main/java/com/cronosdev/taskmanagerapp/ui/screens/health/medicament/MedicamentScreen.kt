...
fun MedicamentScreen (navController: NavHostController, medicamentViewModel: MedicamentViewModel) {
    ...
    LaunchedEffect(Unit) {
        medicamentViewModel.setMedicamentVariables()
        medicamentViewModel.setShowSearchedMedicaments(false)
        medicamentViewModel.fetchAvailableMedicaments(Destinations.HEALTH_MEDICAMENT_SCREEN_URL)
    }
