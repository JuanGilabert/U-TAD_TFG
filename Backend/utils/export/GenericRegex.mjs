...
/* Definimos la expresion regular que valida si un token es valido o no siendo insensible a mayusculas y minusculas con el flag 'i'.
...
export const tokenRegex = /^[A-Za-z0-9-_=]+\.[A-Za-z0-9-_=]+\.?[A-Za-z0-9-_.+/=]$/i;